...
Engagement is likely to be critical to the success of a proposal. One strategy involves a few stages of engagement before submitting a proposal on chain. In the first stage of this strategy, you should engage people informally about your idea.
...
There will likely be differences of opinion about the value of what you're proposing to do and the strategy by which you're planning to do it. If you've considered the feedback think that what you're doing is valuable and that your strategy should work, and you believe that others feel this way as well, it's likely worth drafting a proposal. However, remember that the largest ATOM stakers have the biggest vote, so a vocal minority isn't necessarily representative or predictive of the on-chain vote. A conservative approach is to ensure that you have initial support from a majority of the voting power before proceeding to draft your proposal. There are other approaches, and if your idea is important enough, you may want to pursue it regardless.
...
I intend to expand this [guide to include testnet instructions](https://github.com/gavinly/CosmosCommunitySpend/blob/master/submitting.md#submitting-your-proposal-to-the-testnet). You may want to submit your proposal to the testnet chain before the mainnet for a number of reasons, such as wanting to see what the proposal description will look like, to share what the proposal will look like in advance with stakeholders, and to signal that your proposal is about to go live on the mainnet.
